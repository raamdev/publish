		...
		function rd_sharing_buttons_text()
			{
				...
				<div class="rd-sharing-buttons">
					...
					<div class="rd-sharing-message">Did you enjoy this? Please <?php if(function_exists('wp_email')) : ?><a href="#email-widget" onClick="_gaq.push(['_trackEvent', 'Sharing Buttons Text', 'Email', 'Email it to a friend']);" id="share-email-widget"><span>email it</span></a> to a friend or <?php endif; ?> share it via <a target="_new" href="https://twitter.com/share?text=<?php echo $clean_title; ?>%20via%20@RaamDev&url=<?php the_permalink(); ?>" title="Share '<?php echo $clean_title; ?>' on Twitter" onclick="share_button_popup(this.href); return false;">Twitter</a>, <a target="_new" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" title="Share '<?php echo $clean_title; ?>' on Facebook" onclick="share_button_popup(this.href); return false;">Facebook</a>, or <a target="_new" href="https://plusone.google.com/_/+1/confirm?hl=en&url=<?php the_permalink(); ?>" title="Share '<?php echo $clean_title; ?>' on Google+" onclick="share_button_popup(this.href); return false;">Google+</a>.
						<br>
